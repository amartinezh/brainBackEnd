...
CREATE TABLE test.media (
    ...
    description character varying(256),
    id_exercise character varying(16)
);
...
9	¿Cuál es la fecha de tu matrimonio?	\N
1	¿Cuál es su fecha de nacimiento?	\N
2	¿Cuál es el lugar donde pasó su infancia?	\N
3	¿Quién era tu padre?	\N
4	¿Quién era tu madre?	\N
5	¿Cómo se llaman tus hermanos/as?	\N
6	¿Cuál era la escuela a la que ibas?	\N
7	¿Vivías en la ciudad o en el campo?	\N
8	¿Cuál fue tu primer trabajo?	\N
\.
...
SELECT pg_catalog.setval('test.session_id_seq', 37, true);
